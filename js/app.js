(() => {
    ...
    function type() {
        ...
        if (isDeleting) {
            typedTextElement.textContent = currentPhrase.substring(0, currentCharacterIndex - 1);
        ...
        cursorElement.classList.toggle("typing", currentCharacterIndex !== currentPhrase.length && currentCharacterIndex !== 0);
    }
